...
@section('content-header')
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="#">Hrd</a></li>
      <li class="active"><a href="{{ route('hrd.department.index') }}">Department</a></li>
    </ol>
  </section>
@stop
	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<div class="col-md-12 box-body-header">  
      		...
      		{!! Form::open(['url'=> '/hrd/department/delete','id'=>'formDeptDelete','method'=>'POST']) !!}
				<table class="table table-striped" id="tableDepartment">
					...
					<tbody>
						@foreach ($depts as $dept)
							<tr>
								<td>
									<input type="checkbox" id="idTableDept" name="id[]" class="checkin" value="{{ $dept->id }}"/>
								</td>
								<td>
									{{$dept->id}}
								</td>
								<td>
									{{ $dept->name }}
									<input type="hidden" id="nameTableDept" value="{{ $dept->name }}">
								</td>
							</tr>
						@endforeach
					</tbody>
