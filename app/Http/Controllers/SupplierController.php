...
class SupplierController extends Controller
{
	...
	$supp = new Supplier();
	$supp->no_supplier = $supp->OfMaxno($request->branch_id, $request->category_id);
	$supp->branch_id = $request->branch_id;
	$supp->category_id = $request->category_id;
	$supp->name = $request->name;
	$supp->npwp = $request->npwp;
	$supp->pkp = $request->pkp;
	$supp->address = $request->address;
	$supp->business_field = $request->business_field;
	$supp->phone = $request->phone;
	$supp->fax = $request->fax;
	$supp->name_pic = $request->name_pic;
	$supp->phone_pic = $request->phone_pic;
	$supp->account_number = $request->account_number;
	$supp->account_name = $request->account_name;
	$supp->bank_id = $request->bank_id;
	$supp->bank_branch = $request->bank_branch;
	$supp->active = true;
	$supp->save();
