...
<?php $__env->startSection('content'); ?>
	<div class="box box-danger">
		...
		<div class="box-body">
            ...
            <div class="col-md-8">
                <a href="<?php echo e(route('memo..create')); ?>" class="btn btn-red" data-toggle="tooltip" data-placement="bottom" title="Add Memo">
              ...
              <tr>
                ...
                <td>
                  <?php if($memo->to_memo == auth()->user()->id): ?>
                    <a href="<?php echo e(route('memo.revise.edit', $memo->token)); ?>" class="btn btn-warning btn-xs">
